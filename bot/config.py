...
# PORTFOLIO STRUCTURE
# ─────────────────────────────────────────────────────
# Floor = 85% of session start wallet value
...
# ─────────────────────────────────────────────────────
DAILY_LOSS_REDUCE_TIER = -0.05   # -5%: size down 50%
DAILY_LOSS_PAUSE_TIER = -0.10    # -10%: no new entries (resume if recovers to -5%)
DAILY_LOSS_HALT_TIER = -0.15     # -15%: done for the day
